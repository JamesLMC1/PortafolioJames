        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          {technicalSkills.map((skill, idx) => (
            <Reveal key={idx} delay={idx * 120}>
              <Tilt3D maxTilt={10}>
                <div
                  className="border border-gray-200 dark:border-gray-700 p-6 hover:border-black dark:hover:border-white transition-all duration-300 bg-white dark:bg-gray-800 h-full glow-on-hover card-3d relative overflow-hidden group"
                >
