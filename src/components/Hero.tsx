      ...
      <div className="max-w-4xl relative z-10">
        <div className="mb-8 space-y-1">
          <p className="animate-enter text-sm md:text-base font-mono text-gray-500 dark:text-gray-400 tracking-wider mt-16 md:mt-0" style={{ animationDelay: '0.1s' }}>
            {t(ui.hero.role)}
            <span className="text-black dark:text-white font-semibold">{t(ui.hero.roleHighlight)}</span>
            {t(ui.hero.roleJunior)}
          </p>
        ...
        <div className="animate-enter space-y-1 max-w-2xl mt-8" style={{ animationDelay: '0.3s' }}>
          <p className="text-base md:text-lg font-mono text-gray-700 dark:text-gray-300 leading-relaxed transition-colors duration-300">
            {t(ui.hero.intro)}{' '}
            <span className="text-black dark:text-white font-semibold">{t(ui.hero.highlightAngular)}</span>,
            <span className="text-black dark:text-white font-semibold">{t(ui.hero.highlightTs)}</span>
            {t(ui.hero.backendWith)}
            <span className="text-black dark:text-white font-semibold">{t(ui.hero.highlightDjango)}</span>.
            {t(ui.hero.introEnd)}
          </p>
        ...
        <div className="animate-enter mt-16 flex items-center gap-3 text-gray-400 dark:text-gray-500 transition-colors duration-300" style={{ animationDelay: '0.5s' }}>
          ...
          <span className="text-xs font-mono tracking-wider">{t(ui.hero.explore)}</span>
        </div>
      </div>
    </section>
  );
